 ...
 * \date 22/07/2014
 *
 * grayscale stratification spot match algorithm, presented by clp
 */

#ifndef GRAYSTRATIFY_H
#define GRAYSTRATIFY_H
...
public:
	GrayStratify();
	virtual ~GrayStratify();

	bool GSMain(ST_MTPAIR&& stMtPair, ST_MTRESULT* pstMtRet);
